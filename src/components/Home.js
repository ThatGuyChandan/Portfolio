...
const Home = () => {
  return (
    <div className="flex">
      <div className="social-icon flex flex-col bg-gray-900 pt-10   sm:hidden ">
        <a
      ...
      <div className="flex-1 bg-gray-900 text-white py-20 px-10 pb-40 sm:py-40 sm:px-40 ">
        <h1 className="text-1xl sm:text-2xl md:text-4xl lg:text-6xl font-bold mb-4">
          Hello, I'm Chandan Thakur.
        </h1>
        <div className="text-1xl  sm:text-4xl md:text-5xl lg:text-7xl ">
          <Typewriter
            options={{
              delay: 300,
              typeSpeed: 20,
            ...
            onInit={(typewriter) => {
              typewriter
                .typeString(
                  "I am a <span class='text-blue-400'>Web Developer</span>"
                )
                .pauseFor(1000)
                .deleteAll()
                .typeString(
